...
- **Server:** Hetzner VPS, Ubuntu 26.04, `5.78.144.63` / `2a01:4ff:1f0:c2ad::1`
...
2. **Cloudflare ready** — onboard **both** `rogerwinter.dev` and
   ...
   A/AAAA records to `5.78.144.63` / the IPv6 address, enable **Authenticated
...
```bash
curl -vk --resolve rogerwinter.dev:443:5.78.144.63 https://rogerwinter.dev
```
