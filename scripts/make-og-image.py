...
Fonts (Syne / Hanken Grotesk) are pulled from Google Fonts into /tmp by
the surrounding shell step so the card matches the live typography.
"""
...
SYNE800  = "/tmp/syne800.ttf"
SYNE700  = "/tmp/syne700.ttf"
HANKEN   = "/tmp/hanken500.ttf"
...
mono_font = ImageFont.truetype(SYNE800, 70)
...
# ── wordmark + tagline ─────────────────────────────────────────────────
name_font = ImageFont.truetype(SYNE700, 104)
tag_font  = ImageFont.truetype(HANKEN, 38)
...
tag_y = rule_y + 30
draw.text((PAD, tag_y),
          "AI-native developer & technical content creator",
